...
Estas operaciones serán de gran ayuda para manipular la información del conjunto de datos y así crear un marco muestral que esté en condiciones óptimas para su uso.

### Caracteres especiales

Debido a que la paquetería *stringr* [@stringr] trabaja principalmente con cadenas de textos, es importante tener en cuenta que los objetos de caracteres se definen a través de comillas, ya sea simples o dobles. La única diferencia está en el caso en que se pretendan usar comillas como parte del texto. En estos casos, la comilla simple es preferible para ser la que defina el texto.
...
\begin{center}
\includegraphics{img/str_view_great_2.png}
\end{center}
...
\begin{center}
\includegraphics{img/str_view_this_2.png}
\end{center}
...
\begin{center}
\includegraphics{img/str_view_up.png}
\end{center}
...
\begin{center}
\includegraphics{img/str_view_^y.png}
\end{center}
...
\begin{center}
\includegraphics{img/str_view_x.png}
\end{center}
...
```
\begin{center}
\includegraphics{img/str_view_^exito.png}
\end{center}

Wickham menciona [@wickham2016r, pag. 203] que, además del caracter especial punto \".\", existen otros cuatro que resultan muy útiles para mostrar patrones particulares.
...
\begin{center}
\includegraphics{img/str_view_tasza_2.png}
\end{center}
...
\begin{center}
\includegraphics{img/str_view_2018_XX.png}
\end{center}
...
\begin{center}
\includegraphics{img/str_view_2018_C[LX]+.png}
\end{center}
...
\begin{center}
\includegraphics{img/str_view_2018_X{3}.png}
\end{center}
...
\begin{center}
\includegraphics{img/str_view_2018_X{1,2}.png}
\end{center}
...
Habiendo platicado de esto, podemos hablar de uno de los temas importantes en muchas ocasiones complerjos de la manipulación de datos...  las fechas. 
