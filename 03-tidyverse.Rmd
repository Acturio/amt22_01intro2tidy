...
Este conjunto de datos contiene tres variables: 
 ...
 2) income repartidos entre los nombres de columna; y 
...
* El _names_to_ da el nombre de la variable que se creará a partir de los datos almacenados en los nombres de columna, es decir, ingresos.
* Los _values_to_ dan el nombre de la variable que se creará a partir de los datos almacenados en el valor de la celda, es decir, count. Ni la columna names_to ni la values_to existen en relig_income, por lo que las proporcionamos como cadenas de caracteres entre comillas.
...
```
\begin{center}
\includegraphics{img/03-tidyverse/str_view_^exito.png}
\end{center}
...
\begin{center}
\includegraphics{img/03-tidyverse/str_view_2018_1.png}
\end{center}
...
\begin{center}
\includegraphics{img/03-tidyverse/str_view_tasza_2.png}
\end{center}
...
\begin{center}
\includegraphics{img/03-tidyverse/str_view_2018_XX.png}
\end{center}
...
\begin{center}
\includegraphics{img/03-tidyverse/str_view_2018_C[LX]+.png}
\end{center}
...
\begin{center}
\includegraphics{img/03-tidyverse/str_view_2018_X{3}.png}
\end{center}
...
\begin{center}
\includegraphics{img/03-tidyverse/str_view_2018_X{1,2}.png}
\end{center}
