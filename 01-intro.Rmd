...
Esta estructura suele ser trabajada de dos formas principales, la primera es construyéndose desde dentro del código conforme se va generando la información, ó bien la segunda, leyendo datos de manera externa. El primer método requiere de la concatenación de 2 o más vectores de la misma dimensión. Los elementos a concatenar se pasan como parámetros de la función cbind.data.frame() ó rbind.data.frame(), dependiendo de si se desean concatenar como renglones o como columnas. A continuación se verá un ejemplo:
