...
Experiencia en el Departamento de Investigación Aplicada y Opinión de la UNAM diseñando metodologías estadísticas para estudios de percepción social. Consultor para empresas y organizaciones como UNODC, GNP, CBX, El Universal, INEGI, UNAM e IZZI.  Actualmente  se desempeña en diferentes proyectos contribuyendo a empresas en temas de ciencia de datos, estadística, series de tiempo, visualización de datos y análisis geoespacial.
